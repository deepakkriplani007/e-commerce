        ...
        <nav className="border-gray-200 px-2">
          <div className=" text-white  py-[12px] flex flex-wrap items-center justify-between">
            ...
            <div className="flex md:order-2">
              ...
              <Link to="/cart">
                <button className=" mr-[24px] ml-[20px] p-[12px] hover:bg-gray-100 hover:text-gray-900 hover:rounded-full">
                  {/* <FontAwesomeIcon
                  icon={faCartShopping}
                  style={{ color: "#fcfcfc" }}
                /> */}
            ...
            >
              <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                <li>
                  <a
                    href="#"
                    className="text-gray-700 rounded hover:bg-blue-700 hover:text-white  mb-[1px] md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0"
                    aria-current="page"
                  >
                    Home
                  </a>
